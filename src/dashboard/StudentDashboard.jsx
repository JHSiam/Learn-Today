...
const StudentDashboard = () => {
  ...
  const navItems = [
    { to: "my-enrolled-classes", icon: <FaBook size={16} />, label: "My Enrolled Classes" },
    ...
    <>
      ...
      >
        ...
        >
          ...
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
            <path d="M12 3L22 8.5L12 14L2 8.5L12 3Z" fill="white" fillOpacity="0.95" />
            <path d="M7 11.5V16.5C7 16.5 9 19 12 19C15 19 17 16.5 17 16.5V11.5" stroke="white" strokeWidth="1.8" strokeLinecap="round" fill="none" />
        ...
        <div className="min-w-0">
          ...
          <p className="text-xs" style={{ color: "rgba(167,139,250,0.45)" }}>Learning Dashboard</p>
        </div>
      </div>
                ...
                style={({ isActive }) =>
                  isActive
                    ? {
                        ...
                        color: "#c4b5fd",
                        boxShadow: "inset 0 0 0 1px rgba(139,92,246,0.4),0 0 12px rgba(124,58,237,0.15)",
                      }
      ...
      <div className="p-4" style={{ borderTop: "1px solid rgba(139,92,246,0.1)" }}>
        ...
        >
          ...
          <div className="min-w-0">
            <p className="text-xs font-semibold truncate" style={{ color: "#c4b5fd" }}>Student</p>
            <p className="text-xs truncate" style={{ color: "rgba(167,139,250,0.45)" }}>Enrolled Member</p>
          </div>
        </div>
      </div>
    </>
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none">
                <path d="M12 3L22 8.5L12 14L2 8.5L12 3Z" fill="white" fillOpacity="0.95" />
                <path d="M7 11.5V16.5C7 16.5 9 19 12 19C15 19 17 16.5 17 16.5V11.5" stroke="white" strokeWidth="2" strokeLinecap="round" fill="none" />
              </svg>
            </div>
            <span
