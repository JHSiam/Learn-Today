      ...
      <div className="p-4" style={{ borderTop: "1px solid rgba(139,92,246,0.1)" }}>
        ...
        >
          ...
          <div className="min-w-0">
            <p className="text-xs font-semibold truncate" style={{ color: "#c4b5fd" }}>Admin</p>
            <p className="text-xs truncate" style={{ color: "rgba(167,139,250,0.45)" }}>Super User</p>
          </div>
        </div>
      </div>
    </>
          ...
          >
            <span
              ...
              style={{
                ...
                background: "#c4b5fd",
                transform: sidebarOpen ? "translateY(3px) rotate(45deg)" : "none",
              }}
            />
            <span
              className="block rounded-full transition-all duration-300"
