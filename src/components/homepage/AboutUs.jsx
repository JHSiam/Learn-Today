...
const AboutUs = () => {
  return (
    <div className="py-12 px-6 md:px-12 lg:px-24 text-center">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-base-content/70 mb-8">
          ...
          , your ultimate online learning platform. Our mission is to provide
          high-quality education to students worldwide, empowering them with
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="card bg-base-200 shadow-lg p-6 rounded-xl hover:scale-105 transition-transform">
          ...
          <p className="text-base-content/70 mt-2">
            Join a vibrant learning community and grow together.
          </p>
        </div>
        ...
        <div className="card bg-base-200 shadow-lg p-6 rounded-xl hover:scale-105 transition-transform">
          ...
          <p className="text-base-content/70 mt-2">
            Unlock new opportunities and advance your career.
          </p>
        </div>
      </div>
    </div>
